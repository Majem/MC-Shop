...
<template>
    <!-- Start Home -->
    <section class="bg-primary-700/30 relative pt-[120px] md:pt-[200px]">
        <div class="container mx-auto">
            <div class="grid grid-cols-1">
                <div class="text-center">
                    <h1 class="capitalize mt-6 mx-auto max-w-[650px] text-[34px] leading-10 md:text-[52px] md:leading-tight font-semibold tracking-[1px]"
                        v-html="$t('site.home.get_started.header')"></h1>
                    <p class="text-muted mt-6 mx-auto max-w-[480px] mb-4">{{ $t('site.home.get_started.slogan') }}</p>
                    <div class="mt-12">
                        <form class="max-w-[380px] mx-auto relative">
                            <input type="email"
                                   class="rounded-full px-5 pr-36 w-full text-sm py-[14px] bg-white border-[#e0e0e0] focus:border-[#e0e0e0] focus:ring focus:ring-transparent"
                                   placeholder="Email">
                            <button
                                class="rounded-full absolute right-[3px] tracking-[1px] top-[3px] text-sm py-[10px] px-[30px] border-2 border-green bg-primary-600 text-white hover:bg-primary-700">
                                {{ $t('user.register') }}
                            </button>
                        </form>
                    </div>
                    <div class="text-center mt-12">
                        <a href="#features" class="text-white"><i
                            class="mdi mdi-arrow-down text-[22px] bg-green rounded-full inline-block h-[52px] w-[52px] leading-[52px]"></i></a>
                    </div>
                </div>
                <div class="max-w-4xl top-[60px] relative mx-auto z-20">
                    <img src="https://i.imgur.com/No1kLQQ.png" alt="travel image" class="image">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Start Services -->
    <section class="bg-white dark:bg-gray-900 pt-[120px] md:pt-[200px]">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Complex store
                    management panel</h2>
        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-1">
                <div class="max-w-[650px] mx-auto text-center">
                    <h2 class="md:text-[38px] text-[34px] font-semibold capitalize z-10 relative leading-[48px] md:leading-[53px]">
                        <span
                            class="bg-green top-6 -z-10 h-[6px] w-[100px] inline-block absolute rounded-[50%] my-0 mx-auto rotate-[160deg]"></span>How
                        easy is it to get started?</h2>
                    <p class="text-muted max-w-[500px] mt-4 mx-auto">Lorem ipsum dolor sit amet, consectetur adipisicing
                        elit. Veritatis eum modi, adipisci facilis.</p>
                </div>
            </div>
            <div class="grid md:grid-cols-3 grid-cols-1 gap-6 mt-12">
                <div>
                    <div class="mt-4 text-center px-6">
                        <div>
                            <p class="bg-green uppercase font-medium text-white py-[10px] px-4 inline-block rounded-lg text-[15px]">
                                Step 1</p>
                        </div>
                        <h4 class="mt-6 text-2xl font-semibold">Design &amp; Devloping</h4>
                ...
                <div>
                    <div class="mt-4 text-center px-6">
                        ...
                        <h4 class="mt-6 text-2xl font-semibold">Testing Project</h4>
                        <p class="text-muted mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                    </div>
                </div>
                <div>
                    <div class="mt-4 text-center px-6">
                        ...
                        <h4 class="mt-6 text-2xl font-semibold">Publisher Project</h4>
                        <p class="text-muted mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                    </div>
                </div>
            </div>
